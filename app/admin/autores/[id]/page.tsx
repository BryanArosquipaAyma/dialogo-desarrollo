...
export default function EditarAutorPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (res.ok) {
        setSuccess("✅ Autor actualizado");
        setTimeout(() => router.push("/admin/autores"), 1000);
      } else {
  ...
  if (loading) return <p className="text-gray-500">Cargando autor...</p>;
      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-6">
        ...
        <div className="flex items-center gap-3 rounded border border-gray-300 bg-white p-4">
          ...
          <label htmlFor="es_nickname" className="text-sm text-gray-700">
            <strong>Publicar con nickname</strong>
          </label>
        </div>
